...
public class ThreadPoolConfig {
    @Bean(value = "threadPoolTaskExecutor", destroyMethod = "destroy")
    public ThreadPoolTaskExecutor threadPoolTaskExecutor() {
        ...
        threadPoolTaskExecutor.setCorePoolSize(processorNum * 2);
        // 设置最大线程数量
        threadPoolTaskExecutor.setMaxPoolSize(processorNum * 4);
        // 设置阻塞任务队列大小
